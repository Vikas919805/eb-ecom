...
public Address(@NotBlank @Size(min = 5, message = "Street name must be atleast 5 characters") String street,
		...
		@NotBlank @Size(min = 6, message = "Country name must be atleast 5 characters") String country,
		@NotBlank @Size(min = 6, message = "Pincode name must be atleast 5 characters") String pincode) {
	super();
	this.street = street;
